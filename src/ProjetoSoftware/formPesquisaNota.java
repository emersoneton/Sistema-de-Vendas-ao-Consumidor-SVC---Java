 ...
 * @author Emerson
 */
public class formPesquisaNota extends javax.swing.JFrame {
    formVendas envia;
    ...
    public formPesquisaNota() {
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from ctenfe where nfeope = '065' and nfenum > '0'"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author Emerson
 */
public class formPesquisaFornecedor extends javax.swing.JFrame {
    formLancaNota envia;
    ...
    public formPesquisaFornecedor() {
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from ccli"); 
                    ...
                    if (rs != null) {
                        while (rs.next()) {
                            tab.addRow(new String[]{
                                rs.getString("CLI_COD"),rs.getString("CLI_NOME")});
                        }
                    }
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
       try{
           ...
           envia.importaFornecedor(Table_click);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

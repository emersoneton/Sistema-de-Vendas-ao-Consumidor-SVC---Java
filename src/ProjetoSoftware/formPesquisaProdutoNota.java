 ...
 * @author Emerson
 */
public class formPesquisaProdutoNota extends javax.swing.JFrame {
    formLancaNota envia;
     ...
     */
    public formPesquisaProdutoNota() {
        initComponents();
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from cpro ORDER BY pro_cod"); 
                    ...
                    if (rs != null) {
                        while (rs.next()) {
                            tab.addRow(new String[]{
                                rs.getString("pro_cod"),rs.getString("pro_des")});
                        }
                    }
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
       try{
           ...
           envia.importaProduto(Table_click);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaProdutoNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

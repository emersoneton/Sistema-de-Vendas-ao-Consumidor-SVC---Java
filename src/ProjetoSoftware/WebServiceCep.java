 ...
 * <BR>} else {
 * <BR>&nbsp; &nbsp; System.out.println("Erro numero: " + cep.getResulCode());
 * <BR>&nbsp; &nbsp; System.out.println("Descricao do erro: " + cep.getResultText());
 * <BR>}
 * <BR></tt>
	...
	public static WebServiceCep searchCep(String cep) {
		...
		try {
			...
			if (ex.getNestedException() != null && ex.getNestedException() 
				...
				loadCep.setResultText("Site nao encontrado.");
			...
			loadCep.setExceptio(ex);
			loadCep.setResultText("Erro na formacao da url.");

 ...
 * @author Emerson
 */
public class formPesquisaUnidade extends javax.swing.JFrame {
    formCadastraGrupo envia;
    ...
    public formPesquisaUnidade() {
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from cunidade ORDER BY unidade_cod"); 
                    ...
                    if (rs != null) {
                        while (rs.next()) {
                            tab.addRow(new String[]{
                                rs.getString("unidade_cod"),rs.getString("unidade_des")});
                        }
                    }
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
       try{
           ...
           envia = new formCadastraGrupo();
           
           envia.setVisible(true);
           
           envia.importaUnidade(Table_click);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaUnidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author Emerson
 */
public class formPesquisaReceita extends javax.swing.JFrame {
    formDocumentoSangrias envia;
    ...
    public formPesquisaReceita() {
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from docrec ORDER BY docnum"); 
                    ...
                    if (rs != null) {
                        while (rs.next()) {
                            tab.addRow(new String[]{
                                rs.getString("docdoc"),rs.getString("docdes")});
                        }
                    }
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Grupos e Unidades");
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
       try{
           ...
           envia = new formDocumentoSangrias();
           
           envia.setVisible(true);
           
           envia.importaGrupo(Table_click);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaReceita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

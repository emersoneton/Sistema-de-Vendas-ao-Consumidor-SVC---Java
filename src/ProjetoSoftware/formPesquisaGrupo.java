 ...
 * @author Emerson
 */
public class formPesquisaGrupo extends javax.swing.JFrame {
    ...
    public formPesquisaGrupo() {
     ...
     public void carregar(){
            ...
            try {
                ...
                try (PreparedStatement posted = con.prepareStatement("select * from cgrupo ORDER BY grupo_cod"); 
                    ...
                    if (rs != null) {
                        while (rs.next()) {
                            tab.addRow(new String[]{
                                rs.getString("grupo_cod"),rs.getString("grupo_des")});
                        }
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPesquisaGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
